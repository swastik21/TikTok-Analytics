...
st.sidebar.markdown("<div><img src='https://png2png.com/wp-content/uploads/2021/08/Tiktok-logo-png.png' width=200 /><h1 style='dispay:inline-block'>TikTok Analytics</h1></div>",unsafe_allow_html=True)
st.sidebar.markdown("This dashboard allows you to analyse trending 📊 tiktok using Python and Streamlit")
...
if st.button('Get Data'):
  call(['python','tiktok_data.py',hashtag])
